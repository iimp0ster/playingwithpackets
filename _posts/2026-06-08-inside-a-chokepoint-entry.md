...
rate and use case decide whether a rule belongs in a hunt or a paging alert — the part that determines
whether a detection survives contact with a real SOC.
...
non-RFC1918 IP) — with full fields.
